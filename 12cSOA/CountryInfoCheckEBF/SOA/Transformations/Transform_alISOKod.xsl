...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [THU JUL 27 13:57:33 EEST 2023].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <ns0:UlkeISOKodIstek>
      <xsl:if test="/ns0:UlkeISOKodIstek/ns0:pReqInfo">
        <ns0:pReqInfo>
          ...
          <xsl:if test="/ns0:UlkeISOKodIstek/ns0:pReqInfo/ns0:RETURN_CODE">
            <ns0:RETURN_CODE>
              <xsl:value-of select="/ns0:UlkeISOKodIstek/ns0:pReqInfo/ns0:RETURN_CODE"/>
            </ns0:RETURN_CODE>
          </xsl:if>
          <xsl:if test="/ns0:UlkeISOKodIstek/ns0:pReqInfo/ns0:RETURN_MESSAGE">
            <ns0:RETURN_MESSAGE>
              <xsl:value-of select="/ns0:UlkeISOKodIstek/ns0:pReqInfo/ns0:RETURN_MESSAGE"/>
            </ns0:RETURN_MESSAGE>
          </xsl:if>
        </ns0:pReqInfo>
      </xsl:if>
      <xsl:if test="/ns0:UlkeISOKodIstek/ns0:sUlkeAdi">
        <ns0:sUlkeAdi>
          <xsl:value-of select="concat(upper-case(substring(/ns0:UlkeISOKodIstek/ns0:sUlkeAdi,1,1)),lower-case(substring(/ns0:UlkeISOKodIstek/ns0:sUlkeAdi,2)))"/>
        </ns0:sUlkeAdi>
      </xsl:if>
    </ns0:UlkeISOKodIstek>
  </xsl:template>
